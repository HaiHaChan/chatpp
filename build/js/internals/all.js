...
var TagButton = function () {
    ...
    _createClass(TagButton, [{
        ...
        value: function addTagButton() {
            ...
            var infoDiv = $('#externalInfoTagsButton');
            infoDiv.html('Info');

            var titleDiv = $('#externalTitleTagsButton');
            titleDiv.html('Title');
            ...
            $("#_externalInfoTagsButton").on('click', function (event) {
                event.preventDefault();
                _this.wrapTextWithTag('info');
            });

            $("#_externalTitleTagsButton").on('click', function (event) {
                event.preventDefault();
                _this.wrapTextWithTag('title');
            });
        }
    }, {
        key: "wrapTextWithTag",
        value: function wrapTextWithTag(tag) {
            var content = this.chat_text_jquery.val();
            var selectedStart = this.chat_text_jquery[0].selectionStart;
            var selectedEnd = this.chat_text_jquery[0].selectionEnd;
            var selectedString = content.substring(selectedStart, selectedEnd);
            var newText = content.substring(0, selectedStart) + " [" + tag + "] " + selectedString + " [/" + tag + "] " + content.substring(selectedEnd, content.length) + " ";
...
var tagButton = new TagButton();
module.exports = tagButton;

},{"../helpers/Common.js":2,"../helpers/Const.js":3}],12:[function(require,module,exports){
"use strict";
...
},{"../helpers/ChatworkFacade.js":1,"../helpers/Common.js":2,"../helpers/Const.js":3}],13:[function(require,module,exports){
"use strict";
...
var TagButton = require("./TagButton.js");
var cw_timer = void 0;
...
},{"./Advertisement.js":4,"./Emoticon.js":5,"./Mention.js":6,"./NotificationDisabler.js":7,"./NotifyAll.js":8,"./RoomInformation.js":9,"./Shortcut.js":10,"./TagButton.js":11,"./ViewEnhancer.js":12}]},{},[13]);
